 ...
 * @apiGroup Auth
 *
 * @apiBody {String} first a user's first name
 * @apiBody {String} last a user's last name
 * @apiBody {String} email a user's email (unique)
 * @apiBody {String} password a user's password
 * @apiBody {String} [username] a username (unique), if none is provided, then email will be used
 *
