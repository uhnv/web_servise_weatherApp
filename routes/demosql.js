 ...
 * @apiGroup DemoSql
 *
 * @apiParam {String} [name] the name to look up. If no name is provided, all names are returned
 *
 ...
 * @apiBody {String} message a message to replace the old message associated with the name
 *
 * @apiSuccess {boolean} success true when the name is inserted
